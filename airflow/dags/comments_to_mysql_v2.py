...
dag = DAG(
    ...
    end_date = datetime(2023, 5, 24, 12, 4), # UTC기준으로 동작
...
def etl(**context):
    ...
    with webdriver.Remote(f'{remote_webdriver}:4444/wd/hub', options=options) as driver:
        ...
        title, input_time = crawling_functions.main(driver, 2)
...
etl = PythonOperator(
    ...
    # 메인 기사 링크
    params = {
        "link": "https://n.news.naver.com/article/079/0003773490?ntype=RANKING",
        "sql_num" : "_2"
    },
    dag = dag
)
